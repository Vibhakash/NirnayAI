...
export default function StatCard({ title, value, icon, color, animateCount }: StatCardProps) {
  ...
  return (
    <motion.div
      className={`border-2 ${colorClasses[color]} rounded-xl p-6 hover:shadow-lg transition-shadow`}
